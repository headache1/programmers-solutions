...
12. 실제 날짜가 계획 날짜보다 밀린 동안에는 하루에 계획표 2일치를 진행한다. 단, D1/D3/D7 복습은 압축하거나 생략하지 않으며 복습 실패 시 신규 분량을 줄인다. 계획 날짜를 따라잡으면 하루 1일치로 복귀한다.
...
| 8/4 | 전화번호 목록 (42577) | D0·정렬 비교 통과 | D0 5분, 정렬 10분 | H3, H2, J(substring) | D | D1 8/5, D3 8/7, D7 8/11 |
| 8/4 | 의상 (42578) | 통과 | 6분 | H0, 검색 없음 | A | D7 8/11 |
...
사용자 요청에 따라 날짜를 따라잡을 때까지 하루 2일치를 진행한다. 오늘은 계획 Day 3까지 완료했으므로 계획 Day 4를 한 묶음 더 진행한다.
...
판정: 조합식의 의미를 설명했으므로 A 확정. D7 복습은 8/11.

오늘 계획한 따라잡기 두 번째 묶음까지 완료.
