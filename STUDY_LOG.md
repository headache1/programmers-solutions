...
| 8/4 | 의상 (42578) | 코드 통과 | 6분 | H0, 검색 없음 | A 후보 / 설명 확인 대기 | D7 후보 8/11 |
...
코드 판정: 정답
등급 후보: A
학습 완료 조건: 조합식의 +1과 마지막 -1을 자기 말로 설명
```
...
뼈대를 제출하지 않았으므로 다음 문제로 넘어가기 전에 아래 한 문장만 자기 말로 작성한다.

```text
각 종류의 개수에 +1을 하는 이유와 마지막에 전체 결과에서 1을 빼는 이유:
```
